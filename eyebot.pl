...
if($args{u}){
	...
	$func->write("="x99);
	$func->write("| Bing:");
	my $bing = Eyebot::Bing->new();
	$bing->search($args{i});
	$func->write("| Site list saved in file sites.txt");
	$func->write("="x99);
	$func->write("| Google:");
	my $google = Eyebot::Google->new();
...
##############################################
# Function background
# This function put Eyebot to background mode
#
#
# Param: nothing
# Return: nothing
